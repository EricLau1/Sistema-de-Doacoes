            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            <a class="js-arrow" href="/entidade">
                                <i class="fas fa-tachometer-alt"></i>Painel 
                            </a>
                        </li>
                        <li>
                            <a href="#">
                                <i class="fas fa-edit"></i>Configurações
                            </a>
                        </li>
                    </ul>
                </div>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                <div class="image">
                                                    <a href="#">
                                                        <img src="assets/images/pikachu.svg" alt="avatar do usuário" />
                                                    </a>
                                                </div>
                                                <div class="content">
                                                    <h5 class="name">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 text-right">
                                <a href="/entidade" class="role user text-light"> Voltar </a>
                            </div>
                        </div>
